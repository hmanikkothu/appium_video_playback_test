...
public abstract class Helpers {
  ...
  private static WebDriverWait driverWaitShort;
  /**
  ...
  public static void init(AndroidDriver webDriver, URL driverServerAddress) {
    ...
    driverWaitShort = new WebDriverWait(webDriver, 5);
  }
  ...
  /**
   * Find an element, if found, execute the 'click' method on it.
   * @param locator
     */
  public static boolean clickIfExists(By locator) {
    WebElement el;
    el = waitShort(locator);
    if (el != null) {
      el.click();
      return true;
    }
  ...
  /**
   * Wait 5 second for locator to find an element
   */
  public static WebElement waitShort(By locator) {
      return driverWaitShort.until(ExpectedConditions.visibilityOfElementLocated(locator));
  }
